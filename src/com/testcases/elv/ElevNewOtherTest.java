...
public class ElevNewOtherTest extends TestBase {
	...
	public Object[][] getTestData() {
		return TestUtil.getData("ElevNewOtherTest", xlsx);
	}

	@Test(priority = 0, dataProvider = "getTestData")
	public void Portal(Hashtable<String, String> data) {
		if (!TestUtil.isExecutable("ElevNewOtherTest", xlsx) || data.get("Runmode").equals("N"))
		...
		dd.deviceInfoOther(data.get("device_info"));
